...
class Path extends Shape
{
    ...
    public function start($attributes)
    {
        ...
        $tempControlY = null;
        $l = 0;
        //-((this.width / 2) + $this.pathOffset.x),
        $t = 0;
        //-((this.height / 2) + $this.pathOffset.y),
        foreach ($path as $current) {
            switch ($current[0]) {
                ...
                case 'C':
                    ...
                    $controlX = $current[3];
                    $controlY = $current[4];
                    $surface->bezierCurveTo($current[1] + $l, $current[2] + $t, $controlX + $l, $controlY + $t, $x + $l, $y + $t);
                    break;
                case 's':
                    ...
                    $surface->bezierCurveTo($controlX + $l, $controlY + $t, $x + $current[1] + $l, $y + $current[2] + $t, $tempX + $l, $tempY + $t);
                ...
                case 'S':
                    ...
                    $surface->bezierCurveTo($controlX + $l, $controlY + $t, $current[1] + $l, $current[2] + $t, $tempX + $l, $tempY + $t);
                    $x = $tempX;
                    $y = $tempY;
                    // set control point to 2nd one of this command
                    // "... the first control point is assumed to be
                ...
                case 'q':
                    ...
                    $controlX = $x + $current[1];
                    $controlY = $y + $current[2];
                    $surface->quadraticCurveTo($controlX + $l, $controlY + $t, $tempX + $l, $tempY + $t);
                    $x = $tempX;
                    $y = $tempY;
                    break;
                case 'Q':
                    ...
                    $tempX = $current[3];
                    $tempY = $current[4];
                    $surface->quadraticCurveTo($current[1] + $l, $current[2] + $t, $tempX + $l, $tempY + $t);
                    $x = $tempX;
                    $y = $tempY;
                    $controlX = $current[1];
                    $controlY = $current[2];
                ...
                case 'T':
                    ...
                    break;
                case 'a':
                    $this->drawArc($surface, $x + $l, $y + $t, array($current[1], $current[2], $current[3], $current[4], $current[5], $current[6] + $x + $l, $current[7] + $y + $t));
                    $x += $current[6];
                    $y += $current[7];
                    break;
                case 'A':
                    // TODO: optimize this
                    $this->drawArc($surface, $x + $l, $y + $t, array($current[1], $current[2], $current[3], $current[4], $current[5], $current[6] + $l, $current[7] + $t));
                    $x = $current[6];
                    $y = $current[7];
                    break;
                case 'z':
    ...
    function drawArc(SurfaceInterface $surface, $fx, $fy, $coords)
    {
        ...
        $tx = $coords[5];
        $ty = $coords[6];
        $segs = array(array(), array(), array(), array());
        $toX = $tx - $fx;
        $toY = $ty - $fy;
    ...
    function segmentToBezier($th2, $th3, $cosTh, $sinTh, $rx, $ry, $cx1, $cy1, $mT, $fromX, $fromY)
    {
        ...
        return array($cp1X, $cp1Y, $cp2X, $cp2Y, $toX, $toY);
    }
