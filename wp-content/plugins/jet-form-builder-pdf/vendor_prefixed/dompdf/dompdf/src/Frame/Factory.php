 ...
 */
namespace JFB_PDF\Vendor\Dompdf\Frame;
...
use JFB_PDF\Vendor\Dompdf\FrameDecorator\Page as PageFrameDecorator;
use JFB_PDF\Vendor\Dompdf\FrameReflower\Page as PageFrameReflower;
...
class Factory
{
    ...
    public static function decorate_frame(Frame $frame, Dompdf $dompdf, ?Frame $root = null) : ?AbstractFrameDecorator
    {
        ...
        $decorator = "JFB_PDF\\Vendor\\Dompdf\\FrameDecorator\\{$decorator}";
        $reflower = "JFB_PDF\\Vendor\\Dompdf\\FrameReflower\\{$reflower}";
    ...
    protected static function getPositionerInstance(string $type) : AbstractPositioner
    {
        if (!isset(self::$_positioners[$type])) {
            $class = '\\JFB_PDF\\Vendor\\Dompdf\\Positioner\\' . $type;
