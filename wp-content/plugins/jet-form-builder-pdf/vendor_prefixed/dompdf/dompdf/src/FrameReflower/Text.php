...
use JFB_PDF\Vendor\Dompdf\FrameDecorator\Inline as InlineFrameDecorator;
...
class Text extends AbstractFrameReflower
{
    ...
    protected function line_break(string $text, BlockFrameDecorator $block, bool $nowrap = \false)
    {
        ...
        $mbp_width = (float) $style->length_in_pt([$style->margin_left, $style->border_left_width, $style->padding_left, $style->padding_right, $style->border_right_width, $style->margin_right], $line_width);
    ...
    protected function layout_line(BlockFrameDecorator $block) : ?bool
    {
        ...
        switch ($white_space) {
            ...
            case "pre-wrap":
                ...
                $first_line = $hard_split !== \false ? \mb_substr($text, 0, $hard_split) : $text;
