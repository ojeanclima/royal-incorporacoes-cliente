...
use JFB_PDF\Vendor\Dompdf\Renderer\AbstractRenderer;
use JFB_PDF\Vendor\Dompdf\Renderer\Block;
use JFB_PDF\Vendor\Dompdf\Renderer\Image;
use JFB_PDF\Vendor\Dompdf\Renderer\ListBullet;
use JFB_PDF\Vendor\Dompdf\Renderer\TableCell;
use JFB_PDF\Vendor\Dompdf\Renderer\TableRowGroup;
use JFB_PDF\Vendor\Dompdf\Renderer\Text;
/**
 * Concrete renderer
 *
...
class Renderer extends AbstractRenderer
{
    ...
    public function render(Frame $frame)
    {
        ...
        if (\in_array($style->visibility, ["hidden", "collapse"], \true)) {
            return;
        }
