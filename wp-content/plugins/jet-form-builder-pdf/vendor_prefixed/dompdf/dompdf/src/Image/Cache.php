 ...
 */
namespace JFB_PDF\Vendor\Dompdf\Image;

use JFB_PDF\Vendor\Dompdf\Options;
use JFB_PDF\Vendor\Dompdf\Helpers;
use JFB_PDF\Vendor\Dompdf\Exception\ImageException;
/**
    ...
    static function resolve_url($url, $protocol, $host, $base_path, Options $options)
    {
        ...
        try {
            ...
            if ($protocol === "file://") {
                ...
                if (($resolved_url = @\tempnam($tmp_dir, "ca_dompdf_img_")) === \false) {
