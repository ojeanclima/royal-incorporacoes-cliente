...
use JFB_PDF\Vendor\Dompdf\FrameDecorator\ListBullet;
use JFB_PDF\Vendor\Dompdf\FrameDecorator\Page;
use JFB_PDF\Vendor\Dompdf\FrameReflower\Text as TextFrameReflower;
use JFB_PDF\Vendor\Dompdf\Positioner\Inline as InlinePositioner;
/**
 * The line box class
 *
    ...
    public function get_float_offsets()
    {
        ...
        foreach ($floating_frames as $child_key => $floating_frame) {
            ...
            if (!$floating_frame->_float_next_line && $cb_w <= $line_w + $floating_width && $cb_w > $line_w) {
                $floating_frame->_float_next_line = \true;
                continue;
            }
